...
class MobsInfo{
    ...
    initMobs() {
        this.addItem(366, 1, EnemyType.LivingSkinnable, "hide"); // Rabit
        this.addItem(369, 3, EnemyType.LivingSkinnable, "hide"); // Wolf
        this.addItem(371, 4, EnemyType.LivingSkinnable, "hide"); // Boar IV
        this.addItem(373, 5, EnemyType.LivingSkinnable, "hide"); // Bear V

        this.addItem(507, 3, EnemyType.LivingSkinnable, "Logs"); // Forest Spirit
        this.addItem(508, 4, EnemyType.LivingSkinnable, "Logs"); // Forest Spirit

        // Mobs in Hornbeem wood
        this.addItem(2007, 5, EnemyType.Enemy, "knifeling"); // Knifeling
        this.addItem(2010, 5, EnemyType.Enemy, "huntress"); // Huntress
        this.addItem(1995, 5, EnemyType.Enemy, "berserker"); // Berserker
        this.addItem(1992, 5, EnemyType.Enemy, "wildling"); // Wildling

        this.addItem(1998, 4, EnemyType.MediumEnemy, "battlescaredberserker"); // battle-scared berserker
        this.addItem(2022, 4, EnemyType.MediumEnemy, "grizzledgiant"); // Grizzled Giant
        this.addItem(2013, 4, EnemyType.Enemy, "renownedhuntress"); // Renowned Huntress

        this.addItem(2031, 5, EnemyType.Enemy, "druid"); // Druid

        // Mobs in Goldshimmer plain
        this.addItem(403, 1, EnemyType.LivingSkinnable, "hide"); // Marmot
        this.addItem(407, 4, EnemyType.LivingSkinnable, "hide"); // Giant stag IV
        this.addItem(409, 5, EnemyType.LivingSkinnable, "hide"); // Terrorbird
        this.addItem(499, 5, EnemyType.LivingSkinnable, "hide"); // Tiger

        this.addItem(411, 6, EnemyType.LivingSkinnable, "hide"); // Hyena
    }
    initMobs_Old()
    {
        //#region Hide        
