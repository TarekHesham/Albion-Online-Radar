...
mobsInfo.loadMobsFromJSON('/config/mobsInfo.json');
    ...
    switch (eventCode)
    {
        ...
        */
        ...
        case EventCodes.Move:
            ...
            playersHandler.updateLocalPlayerPosition(posX, posY);
            mobsHandler.updateMistPosition(id, posX, posY);
            mobsHandler.updateMobPosition(id, posX, posY);
            break;

        case EventCodes.NewCharacter:
            const newPlayer = playersHandler.handleNewPlayerEvent(Parameters, map.isBZ);

            flashTime = newPlayer < 0 ? flashTime : newPlayer;
            break;
